...
import { cardsContainer } from './loader.js';
// class
class City {
    ...
    renderCard = async (city, class_name = 'card') => {
        ...
        if (city.location.name.toLowerCase() + ", " + city.location.region.toLowerCase() === City.getFavorite() && city.location.name.toLowerCase() + ", " + city.location.region.toLowerCase() === currentLocation.toLowerCase()) {
            h2.innerHTML = `${city.location.name} &nbsp;<i class="fa-solid fa-location-dot" style="font-size: 20px;color:blue"></i> &nbsp;<i class="fa-solid fa-star" id="fav" style="font-size: 20px;color:goldenrod"></i>`;
        } else {
